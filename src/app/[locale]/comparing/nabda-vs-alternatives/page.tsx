            ...
            <section className="relative pt-32 pb-16 bg-gradient-to-b from-[#f8f9ff] to-white dark:from-[#0a1628] dark:to-[#060f1e]">
                <div className="container max-w-240 mx-auto px-6">
                    ...
                    <div className="flex flex-wrap gap-4">
                        <Link href="https://dash.nabdaotp.com/en/signup" target="_blank" rel="noopener noreferrer"
                        ...
                        <Link href="https://api.nabdaotp.com/docs" target="_blank" rel="noopener noreferrer"
            ...
            <section className="py-20 bg-white dark:bg-[#060f1e]">
                <div className="container max-w-6xl mx-auto px-6">
                    ...
                    <div className="text-center">
                        ...
                        <a href="https://dash.nabdaotp.com/en/signup" target="_blank" rel="noopener noreferrer"
