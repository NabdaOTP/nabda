            ...
            <div className="container max-w-6xl mx-auto px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-10">
                    {cards.map((card, i) => (
                        <article
                            key={i}
                            className="p-6 rounded-2xl bg-[#f8f9fc] dark:bg-white/4 hover:bg-[#f2f3fa] dark:hover:bg-white/7 transition-colors duration-300"
                        >
                ...
                <div className="text-center">
                    <h2 className="text-2xl md:text-3xl font-bold text-[#0a2540] dark:text-white mb-5">
                    ...
                    <a
                        ...
                        className="inline-flex items-center justify-center px-8 py-3.5 rounded-full bg-[#635bff] hover:bg-[#4f46e5] text-white font-bold text-lg transition-colors"
                    >
