...
export default function ComparisonHero({
    ...
    return (
        <section className="relative pt-20 pb-12 bg-linear-to-b from-[#f8f9ff] to-white dark:from-[#0a1628] dark:to-[#060f1e]">
            <div className="container max-w-240 mx-auto px-6">
                {/* Breadcrumb */}
                <nav className="flex items-center gap-2 text-sm text-[#64748b] dark:text-[#94a3b8] mb-5">
                ...
                {/* Subtitle */}
                <p className="text-lg md:text-xl text-[#475569] dark:text-[#94a3b8] mb-6 max-w-3xl leading-relaxed">
                ...
                <div className="flex flex-wrap gap-3">
                    <Link
                        ...
                        className="inline-flex items-center justify-center px-6 py-2.5 rounded-full bg-[#635bff] hover:bg-[#4f46e5] text-white font-bold text-base transition-colors"
                    >
                    ...
                    <Link
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center justify-center px-6 py-2.5 rounded-full bg-[#635bff]/8 text-[#635bff] dark:bg-[#635bff]/15 dark:text-[#a89fff] hover:bg-[#635bff]/12 dark:hover:bg-[#635bff]/20 font-bold text-base transition-colors"
                    >
